...
monogatari.configuration ('credits', {
    "Developers": {
        "Coding, UI": "<a href='https://x.com/AmanitaJT'>Amanita</a>",
    },

	"Translation and Ripping":{
		"Translation, Key Art Rips": "<a href='https://x.com/samuraisusanoo'>Sus Anoo</a>",
		"Background Rips": "<a href='https://x.com/LoserMao'>Mao</a>",
	},

	"Legal Disclaimer":{
		"1": "This is an unofficial, non-commercial fan project",
		"2": "Yo-kai Watch Puni Puni, its characters, story, music, and related assets are © Level-5 Inc. and their respective copyright holders.",
		"3": "All character sprites, images, audio, and other original game assets used in this project are the property of their respective owners. No copyright infringement is intended"
    }
});
